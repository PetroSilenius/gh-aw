...
3. **Set up the required secret** - [`COPILOT_GITHUB_TOKEN`](/gh-aw/reference/tokens/#copilot-github-token), [`ANTHROPIC_API_KEY`](/gh-aw/reference/tokens/#anthropic-api-key) or [`OPENAI_API_KEY`](/gh-aw/reference/tokens/#openai-api-key).
